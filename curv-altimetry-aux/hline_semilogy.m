function lineHandles = hline_semilogy(y, linePropertiesList, label, textPosition, textPropertiesList, axesHandle, isLineColorSynchronizedWithText)
...
% Acknowledgement:  It was based on hline() written by Brandon Kuczenski.
    ...
    lineHandles = semilogy(axesHandle, Xlimits, [y';y'], linePropertiesList{:});
